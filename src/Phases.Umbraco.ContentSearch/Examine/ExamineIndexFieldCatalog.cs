...
/// <summary>
/// Reads field names from Umbraco external Examine indexes used by Content Search.
/// </summary>
public sealed class ExamineIndexFieldCatalog : IExamineIndexFieldCatalog
{
    ...
    private HashSet<string> ReadFieldNames()
    {
        ...
        {
            ExamineIndexNames.ExternalContentIndex,
            ExamineIndexNames.ExternalMediaIndex,
            ExamineIndexNames.ExternalMemberIndex,
        })
        {
